...
# Discord App token
bbtoken = "NDY5NDY5MzEwNzI5ODQ2Nzk0.DjINFw.ns4iYv36_RSi3WkzAN8t-HpN66w" #REMOVE TOKEN BEFORE SYNC!! -Blaze

# YouTube API key (https://console.developers.google.com/apis/credentials/key)
key = "AIzaSyBhRJG7ct764tJ4fzhMxCui-frIjeFhEsk" #REMOVE KEY BEFORE SYNC!! -Blaze
...
pref = "*" #Command prefix
des = "ZZMare's Red-Bot" #Description shown on using the help command

# Error messages
err_mesg = ":x: **Hata Bulundu!**"
err_mesg_pi = ":x: **Hata Bulundu.**"
err_mesg_permission = ":x: **Yetkin Yok.**"
